        ...
        <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '320px 1fr', gap: '24px', alignItems: 'start' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                    <div className="card">
                        <h3 style={{ fontSize: '14px', fontWeight: 700, color: '#1a1a2e', marginBottom: '16px' }}>Loan Parameters</h3>
                        ...
                        <div style={{ marginBottom: '14px' }}>
                            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px' }}>
                                <label style={{ fontSize: '12px', color: '#64748b' }}>Loan Amount</label>
                                <span style={{ fontSize: '13px', fontWeight: 700, color: '#6366f1' }}>{formatCurrency(P)}</span>
                            </div>
                            <input
                                type="range" min={100000} max={50000000} step={100000} value={P}
                                onChange={e => setSimulatorState({ loanAmount: Number(e.target.value) })}
                                style={{ width: '100%', accentColor: '#6366f1' }}
                            />
                            <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '4px' }}>
                                <span style={{ fontSize: '11px', color: '#94a3b8' }}>₹1L</span>
                                <span style={{ fontSize: '11px', color: '#94a3b8' }}>₹5Cr</span>
                            </div>
                        </div>
                        ...
                        <div style={{ marginBottom: '14px' }}>
                            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px' }}>
                                <label style={{ fontSize: '12px', color: '#64748b' }}>Interest Rate</label>
                                <span style={{ fontSize: '13px', fontWeight: 700, color: '#d97706' }}>{R}% p.a.</span>
                            </div>
                            <input
                                type="range" min={5} max={20} step={0.1} value={R}
                                onChange={e => setSimulatorState({ interestRate: Number(e.target.value) })}
                                style={{ width: '100%', accentColor: '#d97706' }}
                            />
                            <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '4px' }}>
                                <span style={{ fontSize: '11px', color: '#94a3b8' }}>5%</span>
                                <span style={{ fontSize: '11px', color: '#94a3b8' }}>20%</span>
                            </div>
                        </div>
                        ...
                        <div style={{ marginBottom: '14px' }}>
                            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px' }}>
                                <label style={{ fontSize: '12px', color: '#64748b' }}>Tenure</label>
                                <span style={{ fontSize: '13px', fontWeight: 700, color: '#10b981' }}>{T} years</span>
                            </div>
                            <input
                                type="range" min={1} max={loanInfo?.typicalTenure || 30} step={1} value={T}
                                onChange={e => setSimulatorState({ tenure: Number(e.target.value) })}
                                style={{ width: '100%', accentColor: '#10b981' }}
                            />
                            <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '4px' }}>
                                <span style={{ fontSize: '11px', color: '#94a3b8' }}>1yr</span>
                                <span style={{ fontSize: '11px', color: '#94a3b8' }}>{loanInfo?.typicalTenure || 30}yrs</span>
                            </div>
                        </div>
                        ...
                        <div style={{ marginBottom: '14px' }}>
                            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px' }}>
                                <label style={{ fontSize: '12px', color: '#64748b' }}>Monthly Income</label>
                                <span style={{ fontSize: '13px', fontWeight: 700, color: '#8b5cf6' }}>{formatCurrency(income)}</span>
                            </div>
                            <input
                                type="range" min={20000} max={1000000} step={5000} value={income}
                        ...
                        {incomeBurden > 50 && (
                            <div style={{
                                ...
                                <div>
                                    <div style={{ fontSize: '12px', fontWeight: 700, color: '#dc2626' }}>High EMI Burden Warning</div>
                    ...
                    <div className="card">
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
                            <h3 style={{ fontSize: '14px', fontWeight: 700, color: '#1a1a2e' }}>Early Foreclosure</h3>
                            <label style={{ display: 'flex', alignItems: 'center', gap: '6px', cursor: 'pointer' }}>
                                ...
                                />
                                <span style={{ fontSize: '12px', color: '#64748b' }}>Enable</span>
                            </label>
                        </div>
                        {showForeclosure && (
                            <>
                                <div style={{ marginBottom: '12px' }}>
                                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px' }}>
                                        <label style={{ fontSize: '12px', color: '#64748b' }}>Foreclose after</label>
                                        <span style={{ fontSize: '13px', fontWeight: 700, color: '#6366f1' }}>{foreclosureMonth} months</span>
                                    </div>
                                    <input
                                        type="range" min={6} max={T * 12 - 6} step={6} value={foreclosureMonth}
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                    {[
                                        { label: 'Outstanding Balance', value: formatCurrency(Math.round(foreclosureData.outstanding)), color: '#dc2626' },
                                        { label: 'Total Paid', value: formatCurrency(Math.round(foreclosureData.paidTillNow)), color: '#6366f1' },
                                        { label: 'Interest Saved', value: formatCurrency(Math.round(foreclosureData.savings)), color: '#16a34a' },
                                    ].map(item => (
                                        <div key={item.label} style={{ display: 'flex', justifyContent: 'space-between', padding: '8px 10px', background: '#f8fafc', border: '1px solid #e5e7eb', borderRadius: '6px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '12px' }}>
                        {[
                            { label: 'Monthly EMI', value: formatCurrency(Math.round(emi)), sub: 'Per month', color: '#6366f1' },
                            { label: 'Total Repayment', value: formatCurrency(Math.round(totalRepayment)), sub: `Over ${T} years`, color: '#d97706' },
                            { label: 'Total Interest', value: formatCurrency(Math.round(totalInterest)), sub: `${((totalInterest / P) * 100).toFixed(0)}% of principal`, color: '#dc2626' },
                            { label: 'Income Burden', value: `${incomeBurden.toFixed(1)}%`, sub: incomeBurden > 50 ? 'High' : 'Safe', color: incomeBurden > 50 ? '#dc2626' : '#16a34a' },
                        ].map((metric) => (
                            <div key={metric.label} className="card" style={{ textAlign: 'center' }}>
                                ...
                                <div style={{ fontSize: '11px', color: '#94a3b8', marginTop: '2px' }}>{metric.sub}</div>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="card">
                        <div style={{ marginBottom: '16px' }}>
                            <h3 style={{ fontFamily: 'Outfit', fontSize: '15px', color: '#1a1a2e' }}>Interest Rate Impact Simulation</h3>
                            ...
                            <BarChart data={rateSimData} barSize={40}>
                                ...
                                <Bar dataKey="emi" name="Monthly EMI" fill="#6366f1" radius={[4, 4, 0, 0]}>
                                    {rateSimData.map((entry, i) => (
                                        <Cell key={i} fill={entry.rate === `${R.toFixed(1)}%` ? '#6366f1' : i > 2 ? `rgba(220,38,38,${0.5 + i * 0.1})` : `rgba(22,163,74,${0.5 + (2 - i) * 0.1})`} />
                                    ))}
                                </Bar>
                            </BarChart>
                        </ResponsiveContainer>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                        ...
                        <div className="card">
                            <div style={{ marginBottom: '16px' }}>
                                <h3 style={{ fontFamily: 'Outfit', fontSize: '15px', color: '#1a1a2e' }}>Amortization Schedule</h3>
                        ...
                        <div className="card">
                            <div style={{ marginBottom: '16px' }}>
                                <h3 style={{ fontFamily: 'Outfit', fontSize: '15px', color: '#1a1a2e' }}>Cost Breakdown</h3>
